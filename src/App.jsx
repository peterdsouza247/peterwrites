...
/* TRAILER DROPDOWN */
.trailer-toggle{margin-top:1.5rem;background:none;border:1px solid rgba(191,63,16,.3);padding:.5rem 1.2rem;font-family:var(--font-label);font-size:.5rem;letter-spacing:.3em;text-transform:uppercase;color:var(--ember);cursor:pointer;display:flex;align-items:center;gap:.6rem;transition:all .25s;}
.trailer-toggle:hover{border-color:var(--ember);background:rgba(191,63,16,.06);}
.trailer-toggle-icon{transition:transform .3s;font-size:.7rem;display:inline-block;}
.trailer-toggle-icon.open{transform:rotate(180deg);}
.trailer-dropdown{overflow:hidden;transition:max-height .45s cubic-bezier(.4,0,.2,1),opacity .35s;max-height:0;opacity:0;}
.trailer-dropdown.open{max-height:600px;opacity:1;}
.trailer-frame{margin-top:1rem;position:relative;width:100%;max-width:200px;aspect-ratio:9/16;background:var(--shadow);border:1px solid rgba(192,144,64,.12);overflow:hidden;box-shadow:0 8px 40px rgba(0,0,0,.5),0 0 30px rgba(191,63,16,.08);}
      ...
      <div className="si">
        ...
        <div className="works-card" key={animKey}>
          ...
          <div className="works-info">
            ...
            {b.trailer && (
              <>
                <button className="trailer-toggle" onClick={() => setTrailerOpen(o => !o)}>
                  ▶ Watch Trailer
                  <span className={`trailer-toggle-icon${trailerOpen ? " open" : ""}`}>▾</span>
                </button>
                <div className={`trailer-dropdown${trailerOpen ? " open" : ""}`}>
    ...
    <section id="arc">
      <div className="si">
        <div className="arc-layout">
          ...
          <div>
            {!formOpen ? (
              <div className="comm-closed" style={{ textAlign: "center" }}>
                <div className="comm-closed-icon">📖</div>
                <div className="comm-closed-title">ARC Submissions Open</div>
                <p className="comm-closed-text">
                  Think your book is a fit? Fill in the form and I'll take a look.
                </p>
                <div style={{ marginTop: "1.5rem" }}>
                  <button className="btn-fire" style={{ fontSize: ".58rem" }} onClick={() => setFormOpen(true)}>
                    📖 Submit Your ARC
                  </button>
                </div>
              </div>
              ...
              <>
                <button
                  ...
                  style={{ background: "none", border: "none", cursor: "pointer", fontFamily: "var(--font-label)", fontSize: ".5rem", letterSpacing: ".35em", textTransform: "uppercase", color: "var(--ash)", opacity: .5, marginBottom: "1rem", display: "flex", alignItems: "center", gap: ".4rem" }}
                >
                  ◂ Collapse
                </button>
                <ARCForm />
      ...
      <div className="si">
        <div className="comm-layout">
          <div className="comm-lore">
            ...
            <button className="tnc-toggle" onClick={() => setPricingOpen(o => !o)} style={{ marginTop: 0, marginBottom: pricingOpen ? 0 : "1rem" }}>
              <span className="tnc-toggle-label">💰 Pricing</span>
              <span className={`tnc-toggle-icon${pricingOpen ? " open" : ""}`}>▾</span>
            </button>

            {pricingOpen && (
              <div className="tnc-body" style={{ marginBottom: "1rem" }}>
